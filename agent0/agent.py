...
class Agent:
	...
	def _model(self):
		...
		visible = Input(shape=(self.state_size,)) #self.state_size
		...
		hidden2 = Dense(5, activation='sigmoid')(visible)
		hidden2 = Dense(5, activation='sigmoid')(hidden2)
		hidden2 = Dense(self.action_size, activation="linear")(hidden2)
		hidden2 = Dropout(dr)(hidden2)

		hidden3 = Dense(5, activation='sigmoid')(hidden2)
		hidden3 = Dense(5, activation='sigmoid')(visible)
		hidden3 = Dense(5, activation='sigmoid')(hidden3)
		hidden3 = Dense(5, activation='sigmoid')(hidden3)
		hidden3 = Dense(self.action_size, activation="linear")(hidden3)
